...
step "building __BLUEPRINT_MAIN__"
...
lake lean __BLUEPRINT_MAIN__.lean -- --run __BLUEPRINT_MAIN__.lean --output _out/site 2>&1 | python3 scripts/filter_docstring_warnings.py --project-root .
